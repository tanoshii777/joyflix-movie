...
export const emailService = {
  async sendMovieApprovedNotification(
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background: #f3f4f6; padding: 20px; border-radius: 8px; margin: 20px 0;">
              ...
              <p><strong>Request ID:</strong> #${request.id
                .toString()
                .slice(-6)}</p>
  ...
  async sendMovieAvailableNotification(
    request: MovieRequest,
    userEmail: string
  ): Promise<boolean> {
    try {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${
                process.env.NEXT_PUBLIC_APP_URL || "http://192.168.68.103:3000"
              }" 
